...
- 🔹 **Computer Science Base:** Currently prioritizing C++ fundamentals, procedural logic, and memory management to establish a rock-solid CS foundation.
- 🔹 **Algorithmic Thinking:** Practicing daily on CodeWars. My roadmap includes mastering Data Structures & Algorithms (DSA), followed by tackling advanced challenges on LeetCode and ultimately Codeforces.

## 💡 Tech Interests & AI Integration

- 🔹 **Software & App Development:** Passionate about applying my programming logic to build real-world projects, with a strong interest in exploring **Mobile Application Development** and **Web Development**.
- 🔹 **AI & Machine Learning:** My ultimate goal is to merge these domains together—integrating intelligent Machine Learning and AI models into robust, scalable software applications.
